...
const appbarLeftStyleFunction = (screenClass, props) => {
  let colWidth = 12;
...
const appbarRightStyleFunction = (screenClass, props) => {
  let colWidth = 12;
...
const AppBarTest = () => (
  <AppBar flat className="appbar-custom">
    <ScreenClassRender style={appbarLeftStyleFunction}>
    ...
    <ScreenClassRender style={appbarRightStyleFunction}>
  ...
  render() {
    return (
      <div className="App">
        <AppBarTest />
        <div>
        <Col key="asd" sm={4} md={3} lg={2} xl={2} className="sidebar">
          <List selectable ripple>
            <ListItem caption='Create' className="menu-item" leftIcon='create' />
            <ListItem caption='Settings' leftIcon='settings' />
          </List>
        </Col>
        <Col key="asd2" sm={8} md={9} lg={10} xl={10} style={{height: 'calc(100vh - 64px)', overflow: 'auto'}}>
        </Col>
        </div>
